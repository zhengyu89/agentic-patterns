...
> **Attribution:** This project is my personal fork of the excellent [agentic-patterns](https://github.com/neural-maze/agentic-patterns) repository by **neural-maze**. Proper attribution is a core practice in the open-source community, and I want to acknowledge the original author for their foundational work.
